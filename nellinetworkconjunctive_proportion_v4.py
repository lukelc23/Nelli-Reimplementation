...
class Network(torch.nn.Module):
    def __init__(self, items_n, h1_size, w1_weight_std, w2_weight_std, non_linearity=torch.relu_, readouts=1):
        ...
        v3: changes to the proportions of the layers 3 and 4
        ...
        # layer 3/4 initialized to same as Layer 1/2 but with concatenated input
        torch.nn.init.normal_(self.layer_3.weight, std=w1_weight_std)
        torch.nn.init.normal_(self.layer_4.weight, std=w2_weight_std)
